const fs = require('fs');
let content = fs.readFileSync('src/components/superadmin/SuperAdminDashboard.js', 'utf8');

// 1. Add imports
content = content.replace(
    "import AdminAddWarehouse from '../admin/AdminAddWarehouse';",
...
fs.writeFileSync('src/components/superadmin/SuperAdminDashboard.js', content);
