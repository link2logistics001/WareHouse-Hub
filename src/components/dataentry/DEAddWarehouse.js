        ...
        <div className="flex-1 bg-[#f4f5f7] min-h-screen relative overflow-hidden z-0 pb-24">
            ...
            <div className="max-w-5xl mx-auto px-6 sm:px-10 pt-10 relative z-10">
                <div className="mb-10">
                    <button
                        onClick={() => setActiveTab('dashboard')}
                        className="text-slate-500 hover:text-cyan-600 flex items-center gap-2 mb-6 transition-colors font-semibold bg-white/60 px-4 py-2 rounded-lg w-fit border border-white shadow-sm backdrop-blur-md"
                    >
                    ...
                    <div className="relative mb-4 flex justify-between">
                        <div className="absolute top-1/2 left-0 w-full h-1.5 bg-slate-200/50 -translate-y-1/2 rounded-full overflow-hidden backdrop-blur-sm z-0">
                            <motion.div
                                className="h-full bg-gradient-to-r from-cyan-400 to-teal-500 shadow-[0_0_10px_rgba(6,182,212,0.5)]"
                                initial={{ width: 0 }}
                        ...
                        {Array.from({ length: totalSteps }, (_, i) => i + 1).map((s) => (
                            <div
                                key={s}
                                className={`relative z-10 w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-500 ${s < step ? 'bg-cyan-500 text-white shadow-lg shadow-cyan-500/30' : s === step ? 'bg-slate-900 text-white shadow-xl ring-4 ring-slate-900/20' : 'bg-white border-2 border-slate-200 text-slate-400'}`}
                            >
                            ...
                            >
                                ...
                                {step === 1 && (
                                    <div className="p-8 sm:p-10 flex-1">
                                        <SectionHeading
                                            icon={<User className="w-6 h-6 text-cyan-500 drop-shadow-md" />}
                                ...
                                {step === 2 && (
                                    <div className="p-8 sm:p-10 flex-1">
                                        <SectionHeading
                                            icon={<Building2 className="w-6 h-6 text-cyan-500 drop-shadow-md" />}
                                ...
                                {step === 3 && (
                                    <div className="p-8 sm:p-10 flex-1 space-y-10">
                                        <div>
                                            <SectionHeading
                                                icon={<Settings className="w-6 h-6 text-cyan-500 drop-shadow-md" />}
                                        ...
                                        <div>
                                            <SectionHeading
                                                icon={<CheckCircle className="w-6 h-6 text-cyan-500 drop-shadow-md" />}
                            ...
                            {step < totalSteps ? (
                                ...
                                >
                                    {submitting && uploadProgress < 100 && (
                                        <div
                                            className="absolute left-0 top-0 bottom-0 bg-cyan-800/20 transition-all duration-300"
    ...
    return (
        <div className="space-y-1.5 relative" ref={dropdownRef}>
            ...
            >
                ...
                <ChevronDown
                    className={`w-4 h-4 text-slate-400 transition-transform duration-300 ${isOpen ? 'rotate-180 text-cyan-500' : ''}`}
                />
            </button>
            <AnimatePresence>
                {isOpen && (
                            ...
                            {options.map((opt) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-3 text-sm font-semibold rounded-xl transition-all flex items-center justify-between mb-0.5 ${isActive ? 'bg-cyan-50 text-cyan-600' : 'text-slate-600 hover:bg-slate-50'}`}
                                    >
            ...
            <div className="flex gap-3">
                {['Yes', 'No'].map((opt) => {
                    ...
                    return (
                        <label
                            key={opt}
                            className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl border cursor-pointer transition-all ${isActive ? 'bg-cyan-500 text-white border-cyan-400 shadow-[0_4px_15px_rgba(6,182,212,0.3)]' : 'bg-white/60 backdrop-blur-sm border-white text-slate-600 hover:border-cyan-200 shadow-sm'}`}
                        >
                            <input
                                type="radio"
                                name={id}
                ...
                {options.map((opt) => {
                    ...
                    return (
                        <button
                            ...
                            className={`px-5 py-2.5 rounded-xl border text-sm font-semibold flex items-center gap-2 transition-all duration-300 ${active ? 'bg-cyan-500 text-white border-cyan-400 shadow-[0_4px_15px_rgba(6,182,212,0.3)]' : 'bg-white/60 backdrop-blur-sm border-white text-slate-600 hover:border-cyan-200 hover:bg-white shadow-sm'}`}
                        >
        ...
        <div className="space-y-2">
            ...
            {file ? (
                ...
                <button
                    ...
                    className={`w-full flex flex-col items-center justify-center gap-3 p-8 border-2 border-dashed rounded-2xl text-center transition-all bg-white/40 backdrop-blur-sm group ${errors[id] ? 'border-rose-400 hover:bg-rose-50/50' : 'border-slate-300 hover:border-cyan-300 hover:bg-white/60'}`}
                >
                    <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform group-hover:shadow-cyan-200">
                        <UploadCloud
                            className={`w-6 h-6 ${errors[id] ? 'text-rose-400' : 'text-slate-400 group-hover:text-cyan-500 transition-colors'}`}
                        />
                    </div>
                    <div>
