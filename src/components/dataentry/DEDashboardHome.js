            ...
            <div className="flex justify-between items-center px-10 py-6 bg-white/90 backdrop-blur-sm border-b border-white sticky top-0 z-20 shadow-[0_4px_30px_rgba(0,0,0,0.02)]">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                        Data Entry Portal — manage your warehouse submissions.
                    </p>
                </div>
                ...
                <div className="flex items-center gap-4">
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-xl text-sm font-semibold text-slate-700 hover:border-cyan-300 hover:shadow-md hover:shadow-cyan-500/10 transition-all focus:ring-2 focus:ring-cyan-500/20 outline-none"
                        >
                                ...
                                >
                                    {timeframes.map((time) => (
                                        <button
                                            ...
                                            className={`w-full text-left px-4 py-2.5 text-sm font-medium rounded-xl transition-colors ${selectedTimeframe === time ? 'text-cyan-600 bg-cyan-50' : 'text-slate-600 hover:bg-slate-50'}`}
                                        >
                                            {time}
                                        </button>
                                    ))}
                    ...
                    <motion.button
                        whileHover={{ scale: 1.03, boxShadow: '0px 10px 25px rgba(6, 182, 212, 0.4)' }}
                        whileTap={{ scale: 0.97 }}
                    ...
                    >
                        <div className="flex justify-between items-center mb-8 relative z-10">
                            ...
                            <button
                                ...
                                className="text-xs font-bold text-cyan-600 hover:text-white bg-cyan-50 hover:bg-cyan-500 hover:shadow-lg hover:shadow-cyan-500/20 px-5 py-2.5 rounded-xl transition-all"
                            >
                                View All
                            </button>
                        </div>
                                ...
                                warehouses.map((wh, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-8">
                                            ...
                                            <span
                                                className={`px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest rounded-full border ${wh.status === 'approved' ? 'bg-emerald-50 text-emerald-600 border-emerald-200/50 shadow-[0_0_15px_rgba(16,185,129,0.15)]' : 'bg-cyan-50 text-cyan-600 border-cyan-200/50 shadow-[0_0_15px_rgba(6,182,212,0.15)]'}`}
                                            >
                                                {wh.status || 'Pending'}
                                            </span>
                                            <button
                                                onClick={() => setActiveTab('my-warehouses')}
                                                className="p-2 text-slate-400 hover:text-cyan-600 hover:bg-cyan-50 rounded-xl transition-all opacity-0 group-hover:opacity-100"
                                            >
                    ...
                    >
                        ...
                        <div className="flex-1 flex flex-col justify-center w-full relative h-48">
                            ...
                            >
                                ...
                                {[
                                    { cx: 300, cy: 100, delay: 1.5 },
                                    { cx: 500, cy: 150, delay: 1.8 },
                                    { cx: 800, cy: 50, delay: 2.1 },
                                ].map((node, i) => (
                                    <g key={i}>
