                    ...
                    <div className="md:col-span-5 lg:col-span-4 space-y-8 pr-4">
                        <Link href="/" className="flex items-center gap-3 group inline-flex">
                            ...
                            <div className="flex flex-col">
                                <span className="font-bold text-white text-2xl tracking-tight leading-none group-hover:text-orange-50 transition-colors">
                                    Link2Logistics
                                </span>
                                <span className="text-xs font-semibold text-orange-500 tracking-widest uppercase mt-1">
                                    Smart Warehousing
                                </span>
                            </div>
                        </Link>
                        ...
                        <p className="text-sm text-slate-400 leading-relaxed font-light">
                            The structural backbone for modern warehouse management. Connect, secure, and streamline
                            your logistics operation. Available across India, UAE, US, UK, and more.
                        </p>
                                ...
                                <ul className="space-y-3 pt-2">
                                    {items.map((item, i) => (
                                        <li key={i}>
                                            ...
                                            >
                                                <span className="opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 text-orange-500 mr-2 transition-all duration-300 ease-out">
                                                    ›
                                                </span>
                    ...
                    <div className="flex gap-6">
                        {['Terms of Service', 'Privacy Policy', 'Security'].map((item, i) => (
                            <a
                                key={i}
                                href="#"
                                className="hover:text-orange-400 transition-colors duration-300 relative group overflow-hidden"
                            >
                                {item}
