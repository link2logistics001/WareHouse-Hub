        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                ...
                <p className="text-slate-500 font-medium mb-8 leading-relaxed">
                    Your account <span className="text-slate-900 font-semibold">({user?.email})</span> has been disabled
                    by an administrator.
                </p>
                ...
                <div className="bg-slate-50 border border-slate-100 rounded-2xl p-6 mb-8 text-left">
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed mb-4">
                        This typically happens if there is an issue with your listings, community violations, or pending
                        verification.
                    </p>
                    <a
