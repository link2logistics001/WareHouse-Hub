...
const DetailRow = ({ label, value, isOrange = true }) => (
    <div className="flex border-b border-slate-200 text-xs">
        <div className={`w-1/3 p-2 font-bold bg-slate-50 border-r ${isOrange ? 'border-orange-200 text-[#0f2b4a]' : 'border-teal-200 text-teal-800'}`}>
            {label}
        </div>
        ...
        <AnimatePresence>
            ...
            >
                <div className="absolute top-4 right-4 flex gap-3 no-print z-10 fixed">
                    ...
                    <button onClick={onClose} className="p-2 bg-white text-slate-700 hover:bg-slate-100 rounded-xl shadow-lg transition-colors">
                        <X className="w-6 h-6" />
                    </button>
                </div>
                ...
                >
                    <div className="p-10">
                        ...
                        <div className="flex border-t-4 border-[#eb6223] pt-0 mb-8">
                            ...
                            <div className="w-[300px] border-2 border-[#eb6223] ml-4 flex flex-col">
                                <h2 className="text-lg font-bold text-[#eb6223] text-center p-3 border-b-2 border-[#eb6223]">
                                    WAREHOUSE<br/>QUOTATION
                                </h2>
                                <div className="p-3 text-xs space-y-3">
                                    <div className="flex justify-between border-b border-slate-200 pb-1">
                                        <span className="font-bold text-slate-700">Quotation No.</span>
                                        <span className="text-slate-500">Q-{quotation.quotation_number || 'DRAFT'}</span>
                                    </div>
                                    <div className="flex justify-between border-b border-slate-200 pb-1">
                                        <span className="font-bold text-slate-700">Date</span>
                                        <span className="text-slate-500">{quotation.created_at ? new Date(quotation.created_at.seconds * 1000).toLocaleDateString() : new Date().toLocaleDateString()}</span>
                                    </div>
                                    <div className="flex justify-between border-b border-slate-200 pb-1">
                        ...
                        <div className="flex gap-4 mb-8">
                            <div className="flex-1 border-2 border-[#eb6223]">
                                <div className="text-[#eb6223] font-bold p-2 text-xs border-b-2 border-[#eb6223]">WAREHOUSE (QUOTATION ISSUED BY)</div>
                                <div>
                            ...
                            <div className="flex-1 border-2 border-teal-600">
                                <div className="text-teal-700 font-bold p-2 text-xs border-b-2 border-teal-600">CLIENT (QUOTATION ADDRESSED TO)</div>
                                <div>
                        ...
                        <SectionHeader letter="B" title="GOODS & STORAGE SCOPE" subtitle="What is being stored — basis for all rate calculation" />
                            ...
                            <tbody>
                                {gs.map((g, i) => (
                                    <tr key={i} className="text-xs border-b border-slate-300">
                                        <td className="p-2 border-r border-slate-300 text-center font-bold text-slate-500">{i+1}</td>
                                        <td className="p-2 border-r border-slate-300 font-bold text-slate-800">{g.description}</td>
                                        <td className="p-2 border-r border-slate-300 text-slate-600">{g.category}</td>
                                        <td className="p-2 border-r border-slate-300 text-center font-bold">{g.quantity}</td>
                                        <td className="p-2 border-r border-slate-300 text-center text-slate-500">{g.unit}</td>
                        ...
                        <div className="break-inside-avoid">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8 text-xs border border-slate-300">
                                <div>
                                    <div className="flex border-b border-slate-300"><div className="w-1/2 p-2 bg-[#0f2b4a] text-white font-bold">Contract Start Date</div><div className="w-1/2 p-2 border-l border-slate-300 font-bold text-[#eb6223]">{ct.start_date || '-'}</div></div>
                                    <div className="flex border-b border-slate-300"><div className="w-1/2 p-2 bg-[#0f2b4a] text-white font-bold">Total Duration</div><div className="w-1/2 p-2 border-l border-slate-300">{ct.duration || '-'}</div></div>
                                    <div className="flex border-b border-slate-300"><div className="w-1/2 p-2 bg-[#0f2b4a] text-white font-bold">Billing Cycle</div><div className="w-1/2 p-2 border-l border-slate-300 italic">{ct.billing_cycle || '-'}</div></div>
                                    <div className="flex border-b border-slate-300"><div className="w-1/2 p-2 bg-[#0f2b4a] text-white font-bold">Minimum Commitment</div><div className="w-1/2 p-2 border-l border-slate-300">{ct.minimum_commitment || '-'}</div></div>
                                    <div className="flex"><div className="w-1/2 p-2 bg-[#0f2b4a] text-white font-bold">Payment Terms</div><div className="w-1/2 p-2 border-l border-slate-300 font-bold">{ct.payment_terms || '-'}</div></div>
                                </div>
                                <div className="border-l border-slate-300">
                                    <div className="flex border-b border-slate-300"><div className="w-1/2 p-2 bg-[#0f2b4a] text-white font-bold">Contract End Date</div><div className="w-1/2 p-2 border-l border-slate-300 font-bold text-[#eb6223]">{ct.end_date || '-'}</div></div>
                                    <div className="flex border-b border-slate-300"><div className="w-1/2 p-2 bg-[#0f2b4a] text-white font-bold">Duration Unit</div><div className="w-1/2 p-2 border-l border-slate-300">{ct.duration_unit || '-'}</div></div>
                                    <div className="flex border-b border-slate-300"><div className="w-1/2 p-2 bg-[#0f2b4a] text-white font-bold">Invoice Raised On</div><div className="w-1/2 p-2 border-l border-slate-300 italic">{ct.invoice_raised_on || '-'}</div></div>
                                    <div className="flex border-b border-slate-300"><div className="w-1/2 p-2 bg-[#0f2b4a] text-white font-bold">Lock-in Period</div><div className="w-1/2 p-2 border-l border-slate-300">{ct.lock_in_period || '-'}</div></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table className="w-full border-collapse text-xs border border-slate-300">
                                    <thead>
                                        <tr className="bg-[#0f2b4a] text-white text-left">
                                            ...
                                            <th className="p-2 border border-slate-400 w-40 text-right">Est. Amount (INR)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colSpan="3" className="p-2 text-right">CGST @ {gst.cgst || 9}%</td>
                                            <td className="p-2 border-l border-slate-300"></td>
                                        </tr>
                                        <tr>
                                            <td colSpan="3" className="p-2 text-right">SGST @ {gst.sgst || 9}%</td>
                                            <td className="p-2 border-l border-slate-300"></td>
                                        </tr>
                                        <tr className="bg-[#0f2b4a] text-white font-bold text-sm">
                                            <td colSpan="3" className="p-3 text-right">GRAND TOTAL (incl. GST)</td>
                        ...
                        <div className="break-inside-avoid mb-6">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-xs">
                                <table className="w-full border-collapse border border-slate-300">
                                    <tbody>
                                        <tr className="border-b border-slate-300"><td className="p-2 bg-slate-100 text-slate-600 font-bold">SAC Code</td><td className="p-2 font-bold text-teal-700">{gst.sac_code || '-'}</td></tr>
                                        <tr className="border-b border-slate-300"><td className="p-2 bg-slate-100 text-slate-600 font-bold">GST Rate</td><td className="p-2 font-bold text-teal-700">{gst.gst_rate || '-'}%</td></tr>
                                        <tr className="border-b border-slate-300"><td className="p-2 bg-slate-100 text-slate-600 font-bold">CGST + SGST</td><td className="p-2 font-bold text-teal-700">{gst.cgst}% + {gst.sgst}%</td></tr>
                                        <tr className="border-b border-slate-300"><td className="p-2 bg-slate-100 text-slate-600 font-bold">IGST</td><td className="p-2 font-bold text-teal-700">{gst.igst}%</td></tr>
                                        <tr><td className="p-2 bg-slate-100 text-slate-600 font-bold">Reverse Charge</td><td className="p-2">{gst.rcm || '-'}</td></tr>
                                    </tbody>
                                </table>
                                <table className="w-full border-collapse border border-slate-300">
                                    <tbody>
                                        <tr className="border-b border-slate-300"><td className="p-2 bg-slate-100 text-slate-600 font-bold">Invoice Type</td><td className="p-2">{gst.invoice_type || '-'}</td></tr>
                                        <tr className="border-b border-slate-300"><td className="p-2 bg-slate-100 text-slate-600 font-bold">Issued By</td><td className="p-2">{gst.issued_by || '-'}</td></tr>
                                        <tr className="border-b border-slate-300"><td className="p-2 bg-slate-100 text-slate-600 font-bold">Place of Supply</td><td className="p-2">{gst.place_of_supply || '-'}</td></tr>
                                        <tr><td className="p-2 bg-slate-100 text-slate-600 font-bold">Invoice Currency</td><td className="p-2">{gst.invoice_currency || '-'}</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </div>
                        ...
                        <div className="break-inside-avoid">
                            ...
                            <div className="flex border border-slate-400 text-xs h-32">
                                <div className="w-1/2 border-r border-slate-400 p-4 flex flex-col justify-between">
                                    ...
                                    <div className="space-y-2 mt-auto">
                                        <div className="flex gap-2"><span className="text-slate-500">Name:</span> <span className="border-b border-slate-400 flex-1"></span></div>
                                        <div className="flex gap-2"><span className="text-slate-500">Date:</span> <span className="border-b border-slate-400 flex-1"></span></div>
                                        <div className="flex gap-2"><span className="text-slate-500">Signature:</span> <span className="border-b border-slate-400 flex-1"></span></div>
                                    </div>
                                </div>
                            ...
                            <div className="mt-4 bg-orange-50 border border-[#eb6223] text-[#eb6223] p-3 text-xs font-bold rounded-sm">
                                IMPORTANT: Once signed by both parties, this quotation and the accompanying Warehouse Service Agreement (WSA) form a binding contract.
                            </div>
                        </div>
                    ...
                    {isMerchantView && quotation.status === 'Sent' && (
                        <div className="no-print bg-slate-50 p-6 border-t border-slate-200 flex justify-end gap-4 rounded-b-[2rem]">
                            ...
                            <button onClick={onAccept} className="flex items-center gap-2 px-8 py-3 bg-green-600 text-white rounded-xl font-bold shadow-lg shadow-green-500/20 hover:bg-green-700 transition-all">
