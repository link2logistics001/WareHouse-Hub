    ...
    const fetchLogs = async () => {
        ...
        try {
            const logsRef = collection(
                db,
                `warehouse_details/warehouse_partner/emails/${user.email.toLowerCase().trim()}/warehouses/${selectedWarehouse.id}/cargo_logs`
            );
                                    ...
                                    <tr key={log.id} className="hover:bg-slate-50/50 transition-colors">
                                        <td className="px-4 py-3">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span
                                                    className={`text-[10px] font-bold uppercase ${log.type === 'arrival' ? 'text-green-700' : 'text-red-700'}`}
                                                >
                                                    {log.type}
                                                </span>
                                            </div>
                                ...
                                <form onSubmit={handleLogSubmit} className="space-y-5">
                                    ...
                                    <div className="flex p-1 bg-slate-100 rounded">
                                        <button
                                            ...
                                            className={`flex-1 py-1.5 text-[10px] font-bold uppercase rounded ${logType === 'arrival' ? 'bg-white text-green-600 shadow-sm' : 'text-slate-500'}`}
                                        >
                                            Arrival
                                        </button>
                                        <button
                                            ...
                                            className={`flex-1 py-1.5 text-[10px] font-bold uppercase rounded ${logType === 'departure' ? 'bg-white text-red-600 shadow-sm' : 'text-slate-500'}`}
                                        >
                                            Departure
                                        </button>
                                    </div>
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full px-3 py-2 border border-slate-300 rounded text-sm outline-none focus:border-blue-500 resize-none"
                                    ...
                                    <div className="pt-2">
                                        <button
                                            ...
                                            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded font-bold text-sm transition-all flex items-center justify-center gap-2"
                                        >
                                            {fetchingLogs ? (
