...
export default function OwnerDashboard({ user, onLogout }) {
    ...
    return (
        <motion.div
            className="min-h-screen bg-[#f4f5f7] flex"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
            ...
            <AnimatePresence>
                {sidebarOpen && (
                    ...
                    >
                        <motion.div
                            className="absolute left-0 top-0 h-full w-72 bg-[#111111] shadow-2xl border-r border-slate-800 flex flex-col"
                            initial={{ x: -300 }}
                            animate={{ x: 0 }}
                            exit={{ x: -300 }}
            ...
            <main className="flex-1 overflow-x-hidden min-h-screen flex flex-col relative z-0">
                    ...
                    activeTab !== 'console' && (
                        <header className="lg:hidden bg-white/90 backdrop-blur-sm border-b border-white px-4 py-3 flex items-center justify-between sticky top-0 z-40">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="w-6 h-6 bg-orange-600 rounded-md flex items-center justify-center text-white font-bold text-xs shadow-sm">
                                    OW
                                </div>
                ...
                <div
                    className={`flex-1 relative ${activeTab === 'dashboard' || activeTab === 'my-warehouses' || activeTab === 'availability' ? '' : 'p-6 sm:p-10'}`}
                >
                    <AnimatePresence mode="wait">
                        {activeTab === 'dashboard' && (
                            <motion.div
                                ...
                                exit={{ opacity: 0 }}
                            >
                                <DashboardHome setActiveTab={setActiveTab} onOpenSidebar={() => setSidebarOpen(true)} />
                            </motion.div>
                        )}
                        {activeTab === 'my-warehouses' && (
                            <motion.div
                        ...
                        {activeTab === 'add-warehouse' && (
                            <motion.div
                                ...
                                exit={{ opacity: 0 }}
                            >
                                <AddWarehouse setActiveTab={setActiveTab} editingWarehouse={editingWarehouse} />
                            </motion.div>
                        )}
                        {activeTab === 'inquiries' && (
                            <motion.div
                        ...
                        {activeTab === 'calendar' && (
                            <motion.div
                                ...
                                exit={{ opacity: 0 }}
                            >
                                <Availability onOpenSidebar={() => setSidebarOpen(true)} />
                            </motion.div>
                        )}
                        {activeTab === 'console' && (
                            <motion.div
            ...
            ════════════════════════════════════════════════════════════════════════ */}
                        {activeTab === 'settings' && (
                            <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                exit={{ opacity: 0, y: -20 }}
                                className="space-y-8 max-w-4xl mx-auto relative z-10 w-full min-h-[80vh]"
                            >
                                    ...
                                    >
                                        <motion.path
                                            ...
                                            transition={{
                                                ...
                                                pathOffset: { duration: 20, ease: 'linear', repeat: Infinity },
                                            }}
                                        />
                                        <motion.path
                                            ...
                                            animate={{ pathLength: 1, pathOffset: [0, 1] }}
                                            transition={{
                                                pathLength: { duration: 4, ease: 'easeOut', delay: 0.5 },
                                                pathOffset: { duration: 25, ease: 'linear', repeat: Infinity },
                                            }}
                                        />
                                        <motion.path
                                            ...
                                            animate={{ pathLength: 1, pathOffset: [0, 1] }}
                                            transition={{
                                                pathLength: { duration: 5, ease: 'easeOut', delay: 1 },
                                                pathOffset: { duration: 30, ease: 'linear', repeat: Infinity },
                                            }}
                                        />
                                        <motion.path
                                            ...
                                            animate={{ pathLength: 1, pathOffset: [0, 1] }}
                                            transition={{
                                                pathLength: { duration: 6, ease: 'easeOut', delay: 1.5 },
                                                pathOffset: { duration: 35, ease: 'linear', repeat: Infinity },
                                            }}
                                        />
                                        <motion.path
                                            ...
                                            animate={{ pathLength: 1, pathOffset: [0, 1] }}
                                            transition={{
                                                pathLength: { duration: 7, ease: 'easeOut', delay: 2 },
                                    ...
                                    <div className="absolute top-6 right-6">
                                        {!editMode && (
                                            <button
                                                ...
                                                className="px-5 py-2.5 bg-white/20 backdrop-blur-md hover:bg-white/30 border border-white/50 text-white rounded-xl font-bold text-sm transition-all flex items-center gap-2 shadow-lg"
                                            >
                                        ...
                                        <div className="relative w-28 h-28 -mt-14 mb-6 group inline-block">
                                            ...
                                            <div className="relative w-full h-full rounded-full border-4 border-white overflow-hidden bg-slate-100 shadow-xl flex items-center justify-center">
                                                ...
                                                <label
                                                    ...
                                                    className="absolute inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 cursor-pointer transition-opacity"
                                                >
                                                    {uploading ? (
                                        ...
                                        <AnimatePresence>
                                            {message.text && (
                                                <motion.div
                                                    ...
                                                    className={`mb-6 p-4 rounded-2xl text-sm font-bold flex items-center gap-2 backdrop-blur-md border ${message.type === 'success' ? 'bg-emerald-500/10 text-emerald-700 border-emerald-500/20' : 'bg-rose-500/10 text-rose-700 border-rose-500/20'}`}
                                                >
                                        ...
                                        {editMode ? (
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full px-5 py-3.5 bg-slate-50/50 backdrop-blur-sm rounded-2xl border border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 outline-none transition-all disabled:opacity-50 font-semibold text-slate-800"
                                                    />
                                                </div>
                                                <div>
                                                    <label className="block text-[11px] font-bold uppercase tracking-widest text-slate-500 mb-2 ml-1">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full px-5 py-3.5 bg-slate-50/50 backdrop-blur-sm rounded-2xl border border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 outline-none transition-all font-semibold text-slate-800"
                                                    />
                                                </div>
                                                <div className="flex gap-3 pt-4 border-t border-slate-100">
                                                    <button
                                                        ...
                                                        disabled={saving}
                                                        className="px-8 py-3.5 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-bold shadow-lg shadow-orange-500/20 hover:shadow-orange-500/40 hover:-translate-y-0.5 transition-all disabled:opacity-50 flex items-center gap-2"
                                                    >
                                                        {saving ? (
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={saving}
                                                        className="px-8 py-3.5 bg-white border border-slate-200 text-slate-600 rounded-xl font-bold hover:bg-slate-50 transition-all shadow-sm"
                                                    >
                                                        Cancel
                                                    </button>
                                                </div>
                                            ...
                                            >
                                                <InfoField
                                                    icon={<User />}
                                                    label="Full Name"
                                                    value={localUser?.name || 'Not Provided'}
                                                />
                                                <InfoField
                                                    icon={<Mail />}
                                                    label="Email Address"
                                                    value={localUser?.email || 'Not Provided'}
                                                />
                                                ...
                                                {localUser?.company ? (
                                                    ...
                                                    <div className="flex flex-col justify-center p-5 bg-white/40 backdrop-blur-md rounded-2xl border border-white border-dashed hover:border-orange-300 transition-colors group">
                                                        ...
                                                        <button
                                                            ...
                                                            className="text-sm w-fit px-5 py-2.5 bg-orange-50 text-orange-600 rounded-xl font-bold transition-all flex items-center gap-2 group-hover:bg-orange-500 group-hover:text-white shadow-sm"
                                                        >
                                                    ...
                                                    <p className="text-sm font-bold text-slate-800 mb-2 flex items-center gap-2">
                                                        {localUser?.emailVerified ? (
                                                            ...
                                                            <>
                                                                ...
                                                                <span className="text-orange-600 font-extrabold tracking-tight">
                                                                    Not Verified
                                                                </span>
                                                            </>
                                                        )}
                                                    ...
                                                    {!localUser?.emailVerified && (
                                                        <div className="flex gap-2">
                                                            <button
                                                                ...
                                                                className="text-[10px] px-3 py-1.5 bg-orange-500 text-white font-bold rounded-lg hover:bg-orange-600 transition-all shadow-sm"
                                                            >
                                                                Resend
                                                            </button>
                                                            <button
                                                                onClick={handleRefreshVerification}
                                                                className="text-[10px] px-3 py-1.5 bg-slate-100 text-slate-600 font-bold rounded-lg hover:bg-slate-200 transition-all"
                                                            >
                                                                Refresh
                                                            </button>
                                                        </div>
                                    ...
                                    <div className="flex items-center gap-4 mb-6 relative z-10">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-medium text-slate-500 mt-0.5">
                                                Manage your active portal session.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white/80 p-5 rounded-2xl border border-white shadow-sm relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-500 font-medium mt-1">
                                                Logging out will securely encrypt and close your current session.
                                            </p>
                                        </div>
                                        <button
                                            onClick={async () => {
                                            ...
                                            className="px-6 py-3 bg-white border border-rose-200 hover:bg-rose-50 hover:border-rose-300 text-rose-600 rounded-xl text-sm font-bold transition-all shadow-sm flex items-center gap-2 shrink-0"
                                        >
