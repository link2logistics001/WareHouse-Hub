  ...
  const roles = [
    {
      ...
      label: 'Merchant',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-orange-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.4} stroke="currentColor">
    ...
    },
    {
      ...
      label: 'Owner',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-slate-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.4} stroke="currentColor">
