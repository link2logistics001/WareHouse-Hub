                ...
                <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="hidden md:flex items-center justify-between h-20 w-full">
                        <motion.a
                            ...
                            className={`font-display font-bold text-xl flex items-center gap-3 group transition-colors duration-300 ${
                                navScrolled ? 'text-slate-900' : 'text-white'
                            }`}
                        ...
                        >
                            ...
                            >
                                ...
                                <img
                                    ...
                                    alt="L2L Logo"
                                    className="w-full h-full object-contain relative z-10 drop-shadow-sm transition-transform duration-300 group-hover:scale-110"
                                />
                            </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="relative" ref={desktopCountryRef}>
                                ...
                                >
                                    ...
                                    <ChevronDown
                                        className={`w-3 h-3 transition-transform ${countryDropdownOpen ? 'rotate-180' : ''}`}
                                    />
                                </button>
                                <AnimatePresence>
                                    {countryDropdownOpen && (
                            ...
                            {user ? (
                                ...
                                <div className="relative" ref={profileRef}>
                                    ...
                                    >
                                        ...
                                        <span
                                            className={`text-sm font-semibold hidden lg:block max-w-[120px] truncate ${
                    ...
                    <div className="flex md:hidden items-center justify-between h-16 w-full">
                        <motion.a
                            href="/"
                            onClick={(e) => handleNavClick(e, '#')}
                            className={`font-display font-bold text-xl flex items-center gap-3 group ${
                                navScrolled ? 'text-slate-900' : 'text-white'
                            }`}
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.95 }}
