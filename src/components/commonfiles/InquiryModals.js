...
import { 
  X, Send, Zap, FileText, CheckCircle2, 
      ...
      >
        <div className="p-8 md:p-12">
          <div className="flex justify-between items-start mb-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight mb-2">Send Enquiry</h2>
              <p className="text-slate-500 font-medium">Choose how you'd like to proceed with your warehouse requirements.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 leading-relaxed font-medium">Answer a few key questions and get pricing within 24 hours.</p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 leading-relaxed font-medium">Comprehensive information for accurate quotations and scoping.</p>
              </div>
      ...
      >
        <div className="bg-white p-6 border-b border-slate-100 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">Quick Inquiry Form</h2>
              <p className="text-[10px] font-black text-orange-500 uppercase tracking-widest">Get pricing within 24 hours</p>
            </div>
          </div>
      ...
      >
        <div className="bg-white p-6 border-b border-slate-100 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">Detailed Warehouse Scoping Form</h2>
              <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest">Comprehensive Information for accurate quotations</p>
            </div>
          </div>
          <button onClick={onClose} className="p-2 hover:bg-slate-50 rounded-full transition-colors text-slate-400">
            <X size={20} />
...
const InputField = React.memo(({ label, icon, type = "text", value, onChange, required = true }) => {
  return (
    <div className="space-y-1.5 flex-1">
      <label className="text-xs font-bold text-slate-500 ml-1 flex items-center gap-1.5">{icon} {label} {required && "(Required)"}</label>
      <input required={required} type={type} value={value} onChange={e => onChange(e.target.value)} className="w-full px-4 py-3 bg-slate-50 rounded-xl border border-slate-200 focus:border-blue-600 outline-none transition-all font-semibold" />
    </div>
  );
});
...
const SelectField = React.memo(({ label, options, value, onChange }) => {
  return (
    <div className="space-y-1.5 flex-1">
      ...
      <select value={value} onChange={e => onChange(e.target.value)} className="w-full px-4 py-3 bg-slate-50 rounded-xl border border-slate-200 outline-none font-bold text-sm">
