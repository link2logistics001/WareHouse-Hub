...
import { ArrowRight, CheckCircle2, Search, MapPin, ShieldCheck, PieChart, TrendingUp, Bell, MessageSquarePlus } from 'lucide-react';
    ...
    <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="space-y-4">
          {[1, 2].map((i) => (
            <div key={i} className="flex gap-4 p-4 rounded-2xl bg-white border border-slate-50 shadow-sm transition-all hover:shadow-md">
      ...
      <motion.div 
        animate={{ y: [8, -8, 8], rotate: [0, 2, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 1 }}
      ...
      >
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-black text-[#E65100] uppercase tracking-widest leading-none mb-0.5">Trust Score</span>
          <span className="text-xs font-bold text-slate-900">Verified Match</span>
        </div>
      </motion.div>
      <motion.div 
        animate={{ y: [-10, 10, -10], rotate: [-6, -2, -6] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 2 }}
      ...
      />
      <div className="absolute inset-0 opacity-[0.15]" style={{ backgroundImage: 'radial-gradient(#E65100 2.5px, transparent 2.5px)', backgroundSize: '40px 40px' }} />
    </div>
  );
});
...
const ProviderVisual = React.memo(() => {
  return (
    <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center p-6">
      ...
      >
        <div className="flex items-center justify-between mb-8">
          <div className="space-y-2">
            <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Global Capacity</div>
            <div className="text-3xl font-black text-white tracking-tight">85% <span className="text-xs font-medium text-slate-400">Filled</span></div>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-[10px] font-bold text-[#E65100] bg-orange-500/10 px-2 py-0.5 rounded-full">LIVE</div>
          </div>
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex items-center justify-between p-3.5 rounded-xl bg-white/[0.03] border border-white/[0.05] hover:bg-white/[0.05] transition-colors">
      ...
      <motion.div 
        animate={{ y: [-8, 8, -8] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 1.5 }}
      ...
      >
        ...
        <div>
          <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Monthly Revenue</div>
      ...
      <div className="pt-24 md:pt-32 pb-12 text-center bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#E65100]">The Ecosystem</span>
            <div className="w-8 h-[2px] bg-[#E65100]"></div>
          </motion.div>
          <motion.h2 
            ...
            <div className="lg:col-span-6 order-2 lg:order-1">
              <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                ...
                <p className="text-base md:text-lg text-slate-600 mb-8 leading-relaxed font-medium max-w-xl">
                  <span className="text-slate-900 font-bold">Manufacturers, 3PLs, e-commerce, and forwarders</span> moving cargo and needing reliable warehouse space.
                </p>
                ...
                <div className="relative p-6 mb-8 rounded-[2rem] bg-gradient-to-br from-orange-50/50 to-white border border-orange-100/50 shadow-sm overflow-hidden group max-w-xl">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-[10px] font-black text-[#E65100] uppercase tracking-[0.2em] mb-1">The Solution</h4>
                      <p className="text-sm md:text-base text-slate-800 font-bold leading-relaxed">
                        We consolidate vetted capacity into a single, high-performance interface for instant scaling.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  {["Discover vetted capacity across your region", "Compare pricing, SLAs, and infrastructure", "Post specific requirements and get matched"].map((feature, i) => (
                    <div key={i} className="flex items-center gap-3">
                      ...
                      <span className="text-sm md:text-base font-bold text-slate-700">{feature}</span>
                    </div>
                  ))}
                </div>
            ...
            <div className="lg:col-span-6 order-2 lg:order-2">
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                ...
                <p className="text-base md:text-lg text-slate-400 mb-8 leading-relaxed font-medium max-w-xl">
                  <span className="text-white font-bold">Owners, operators, and property managers</span> monetizing excess capacity and building a digital-first logistics brand.
                </p>
                ...
                <div className="relative p-6 mb-8 rounded-[2rem] bg-white/[0.03] backdrop-blur-md border border-white/[0.08] shadow-2xl overflow-hidden group max-w-xl">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1">The Opportunity</h4>
                      <p className="text-sm md:text-base text-slate-200 font-bold leading-relaxed">
                        Access a direct pipeline of verified cargo businesses to build recurring revenue and optimize utilization.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  {["List available capacity with operational details", "Get validated and verified as a trusted operator", "Build predictable revenue without heavy sales overhead"].map((feature, i) => (
                    <div key={i} className="flex items-center gap-3">
                      ...
                      <span className="text-sm md:text-base font-bold text-slate-300">{feature}</span>
                    </div>
                  ))}
                </div>
