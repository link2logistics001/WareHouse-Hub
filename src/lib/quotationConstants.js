export const QUOTATION_SCHEMA = {
    storage_charges: [
        {
            id: 'D1',
            head: 'Space Rental — General Dry Storage',
            rate: '',
            unit: 'CBM',
            period: 'Month',
            min_charge: '',
        ...
        {
            id: 'D2',
            head: 'Space Rental — Cold Chain / Reefer Storage',
            rate: '',
            unit: 'CBM',
            period: 'Month',
            min_charge: '',
        ...
        {
            id: 'D3',
            head: 'Space Rental — Bonded Warehouse Storage',
            rate: '',
            unit: 'CBM',
            period: 'Month',
            min_charge: '',
        ...
        {
            id: 'D4',
            head: 'Space Rental — Hazmat / Chemical Storage',
            rate: '',
            unit: 'CBM',
            period: 'Month',
            min_charge: '',
        ...
        {
            id: 'D5',
            head: 'Space Rental — Open Yard / Outdoor Storage',
            rate: '',
            unit: 'CBM',
            period: 'Month',
            min_charge: '',
        ...
        {
            id: 'D6',
            head: 'Space Rental — High-Value / High-Security Bay',
            rate: '',
            unit: 'CBM',
            period: 'Month',
            min_charge: '',
        ...
        {
            id: 'D7',
            head: 'Minimum Space Guarantee Charge',
            rate: '',
            unit: 'CBM',
            period: 'Month',
            min_charge: '',
    ...
    penalty_charges: [
        {
            id: 'H1',
            head: 'Overstay / Demurrage — Storage',
            rate: '',
            unit: 'Day',
            trigger: 'Goods remain beyond contracted end date',
        },
        {
            id: 'H2',
            head: 'Delayed Payment Penalty',
            rate: '',
            unit: '% of Invoice',
            trigger: 'Invoice not paid within agreed payment terms',
        },
        {
            id: 'H3',
            head: 'Early Termination Charge',
            rate: '',
            unit: 'Flat Fee',
            trigger: 'Contract cancelled before lock-in period ends',
        },
        {
            id: 'H4',
            head: 'Excess Quantity Surcharge',
            rate: '',
            unit: 'CBM',
            trigger: 'Quantity received exceeds contracted volume',
        },
        {
            id: 'H5',
            head: 'Unscheduled Inward / Outward Charge',
            rate: '',
            unit: 'Flat Fee',
            trigger: 'Truck/consignment arrives without prior intimation',
        },
        {
            id: 'H6',
            head: 'Rejection / Return Handling Charge',
            rate: '',
            unit: 'Flat Fee',
            trigger: 'Goods returned to sender after failed delivery',
        },
    ],
    gst_compliance: {
        sac_code: '996719',
...
export const INITIAL_QUOTATION_DATA = {
    ...
    goods_scope: [{ sr: 1, description: '', category: '', quantity: '', unit: 'CBM', condition: 'Ambient' }],
    contract_tenure: {
        start_date: '',
        end_date: '',
        duration: '',
        ...
        invoice_raised_on: '1st of month',
        minimum_commitment: '',
        lock_in_period: '',
